...
//    }
    ...
    public Long getLastMonumentId() throws SQLException{
        Long monumentId = 0l;
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public void incrementMonumentId() throws SQLException{
        Long monumentId = 0l;
        String query = "";
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public void incrementTemperatureId(Long monumentId) throws  SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public void incrementNoiseId(Long monumentId) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public void addMonumentResourceIds(Long monumentId, Long warningCount, Long postCount, Long temperatureCount, Long noiseCount) throws SQLException{
...
//        }
    ...
    public void incrementWarningId(Long monumentId) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public void incrementPostId(Long monumentId) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public Long getNextTemperatureId(Long monumentId) throws SQLException{
        Long tempId = 0l;
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public Long getNextNoiseId(Long monumentId) throws SQLException{
        Long noiseId = 0l;
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public Long getNextPostId(Long monumentId) throws SQLException{
        Long postId = 0l;
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public Long getNextWarningId(Long monumentId) throws SQLException{
        Long warningId = 0l;
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public Warning saveWarning(Warning warning, Long monumentId) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public void deleteWarning(Warning warning) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public List<Warning> getWarnings(Monument monument) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public boolean changeCustodianStatus(boolean status, User user) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public boolean updateMonumentId(User user, long monumentId) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public int updateUserScore(User user, int score) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public int getUserScore(User user) throws SQLException{
...
//            if(dbCon != null){ dbCon.close(); }
    ...
    public List<User> getAllOldCustodians() throws SQLException{
